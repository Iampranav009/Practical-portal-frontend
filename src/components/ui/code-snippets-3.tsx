...
/* =========================
   ...
   ========================= */
interface InlineCopyButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  value: string
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "border-transparent/0 hover:border-transparent/0",
        className
      )}
      {...props}
    >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Highlight theme={selectedTheme} code={currentCode.trim()} language={currentLanguage as string}>

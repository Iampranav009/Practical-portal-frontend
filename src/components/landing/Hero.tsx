  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight js-animate">
        ...
        <p className="text-lg sm:text-xl text-white/90 max-w-4xl mx-auto mb-6 leading-relaxed js-animate">
        ...
        <div className="max-w-3xl mx-auto mb-8 js-animate">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12 js-animate">
          <Button 
            asChild 
            size="lg" 
            className="bg-white text-black hover:bg-gray-100 px-10 py-4 text-xl font-semibold rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
          >
          ...
          <Button 
            ...
            variant="outline" 
            size="lg"
            className="bg-transparent text-white border-2 border-white/50 hover:bg-white hover:text-black px-10 py-4 text-xl font-semibold rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 backdrop-blur-sm"
          >
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 js-animate">
